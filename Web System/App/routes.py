...
def create_post():
    ...
    if form.validate_on_submit():
        ...
        modelName2 = "/Users/alex/Desktop/Flask Web Server/App/model/category/Bi_LSTM.model"

        sess2 = tf.compat.v1.Session()
        sess2.run(init2)
        saver2.restore(sess2, modelName2)  # 얘네가 문제
        ...
        embedding2 = Convert2Vec('/Users/alex/Desktop/Flask Web Server/App/model/category/post.embedding', tokens)
        ...
        Tag = ["IT science :", "Economy :", "Politics :", "E-sports :", "Golf :", "Basket ball :",
               "Volley ball :", "Base ball :", "Other sports :", "Foot ball :", "Social :", "Life / Culture :"]
